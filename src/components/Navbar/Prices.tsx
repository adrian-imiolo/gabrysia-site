function Prices() {
  ...
  return (
    <section className="prices">
      <p>Wysokość wynagrodzenia jest każdorazowo ustalana z Klientem.
Podczas spotkania wspólnie ustalam z Klientem, w jaki sposób mogę mu pomóc i jaki będzie
zakres jego zlecenia. Przy ustalaniu mojego wynagrodzenia uwzględniam specyfikę i stopień
skomplikowania sprawy, czas jej trwania, mój nakład pracy oraz charakter współpracy z
Klientem. Biorę również pod uwagę możliwości finansowe Klienta - ma to istotne znaczenie,
a uważam, że każdy ma prawo do pomocy prawnej.
Potrzeby każdego Klienta są różne, wobec tego stosuję następujące modele wynagradzania:
- wynagrodzenie stałe (ryczałt) - w przypadku realizacji części usług już na początku jestem
...
trakcie pracy nad daną sprawą;
- wynagrodzenie godzinowe - kiedy nie jestem w stanie przewidzieć, jaką konkretną ilość
...
również ustalana z Klientem;
- wynagrodzenie mieszane - jest to połączenie dwóch powyższych wynagrodzeń, w sytuacji
...
podstawie uzgodnionej stawki godzinowej
- wynagrodzenie uzależnione od wartości przedmiotu sporu - jest to model wynagrodzenia,
...
Stawki minimalne wynoszą przy wartości przedmiotu sprawy:</p>
<ol>
...
<p>
Z kolei w sprawach rozpoznawanych w postępowaniu upominawczym, elektronicznym
postępowaniu upominawczym, postępowaniu nakazowym oraz europejskim postępowaniu
nakazowym stawki minimalne wynoszą przy wartości przedmiotu sprawy:
