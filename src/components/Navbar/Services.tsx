    ...
    <section className="services">
      ...
      <div className="services-container">
        <div className="services-box">
          <h3>Prawo cywilne</h3>
          <p>Jednym z głównych obszarów moich zainteresowań oraz praktyki prawniczej jest szeroko
rozumiane prawo cywilne. Prowadzę spory sądowe, ale także zajmuję się bieżącym doradztwem,
polegającym na sporządzaniu opinii prawnych czy przygotowywaniu umów.</p>
<br />
          <p>W szczególności są to sprawy:
          &bull; o zapłatę
...
&bull; dotyczące kwestii zasiedzenia</p>
        </div>
        <div className="services-box">
          <h3>Prawo rodzinne oraz międzynarodowe prawo rodzinne</h3>
          <p>Kolejnym, jednym z głównych obszarów mojej praktyki są sprawy z zakresu prawa rodzinnego.
Prowadzę również sprawy dotyczące międzynarodowego prawa rodzinnego i udzielam porad
prawnych w tym zakresie obcokrajowcom.</p>
<br />
<p>W szczególności są to następujące sprawy:
...
&bull; ustalenie i zaprzeczenie pochodzenia dziecka</p>
        </div>
        <div className="services-box">
          <h3>Prawo pracy</h3>
          <p>Prowadzę również sprawy z zakresu prawa pracy, na etapie przedsądowym i sądowym, świadcząc
pomoc prawną zarówno pracownikom, jak i pracodawcom.</p>
<br />
<p>
W szczególności są to następujące sprawy:
...
&bull; mobbing
        ...
        <div className="services-box">
          <h3>Prawo karne</h3>
          <p>Posiadam również doświadczenie w prowadzeniu sprawach wykroczeniowych oraz karnych w
każdym stadium postępowania, tj na etapie postępowania przygotowawczego, sądowego oraz
wykonawczego.</p>
<br />
<p>W szczególności zajmuję się:
...
&bull; reprezentacją pokrzywdzonych (oskarżycieli</p>
        </div>
        <div className="services-box">
          <h3>Prawo administracyjne</h3>
          <p>Posiadam doświadczenie w prowadzeniu sprawa przed organami władzy publicznej oraz sądami
administracyjnymi. Sporządzam odwołania od decyzji administracyjnych, skargi do wojewódzkich
...
legalizacja pobytu).</p>
        </div>
        <div className="services-box">
          <h3>Prawo gospodarcze</h3>
          <p>Świadczę pomoc prawną przedsiębiorcom prowadzącym jednoosobową działalność gospodarczą, jak
i spółkom prawa handlowego. Jest to kompleksowa obsługa prawna, obejmująca: doradztwo prawne
i sporządzanie opinii prawnych, rejestrację przedsiębiorstw, sporządzanie i opiniowanie umów,
prowadzenie sporów sądowych, udział w negocjacjach oraz windykację wierzytelności.</p>
        </div>
      </div>
    </section>
  )
